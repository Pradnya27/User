 ...
 * @category View  Registered candidate for QTP_framework            *
...
if ($login_check['login_check'] == 0) {
   ...
   unset($validate);
            ...
            $query = "Select * from register where course='QTP-Framework'"; //fetching data from database
            ...
            //closing database connection created
