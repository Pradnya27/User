 ...
 * @category View  Registered candidate for STA-JAVA                     *
 * This code belongs to generation of reprots for STA-JAVA.               *
...
if ($login_check['login_check'] == 0) {
   ...
   unset($validate);
            ...
            $query = "Select * from register where course='STA-Java'";
